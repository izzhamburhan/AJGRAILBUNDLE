...
<!--------single products details------->
	...
	<div class="small-container single-product">
		<div class="row">
			<div class="col-2">
				<img src="images/mellow.jpg" width="100%" id="ProductImg">
				
				<div class="small-img-row">
					<div class="small-img-col">
						<img src="images/mellow.jpg" width="100%" class="small-img">
					</div>
					<div class="small-img-col">
						<img src="images/mellow2.jpg" width="100%" class="small-img">
					</div>
					<div class="small-img-col">
						<img src="images/mellow3.jpg" width="100%" class="small-img">
					</div>
					<div class="small-img-col">
						<img src="images/mellow4.jpg" width="100%" class="small-img">
					</div>
				</div>
			...
			<div class="col-2">
				...
				<input type="hidden" name="Item_Name" value="Mellow Crunch">
				<input type="hidden" name="Price" value="13">
				
				<h3>Product Details</h3>
				<p>
				<br>Life is like a chocolate box,
				<br>Each chocolate is like a portion of life,
				<br>Some are crunchy, some are nutty,
				<br>Some are soft but all are delicious! 
				</p>
			</div>
			</form>
		</div>
