...
<!--------single products details------->
	...
	<div class="small-container single-product">
		<div class="row">
			<div class="col-2">
				<img src="images/brownie.jpg" width="100%" id="ProductImg">
				
				<div class="small-img-row">
					<div class="small-img-col">
						<img src="images/brownie.jpg" width="100%" class="small-img">
					</div>
					<div class="small-img-col">
						<img src="images/brownie2.jpg" width="100%" class="small-img">
					</div>
					<div class="small-img-col">
						<img src="images/brownie3.jpg" width="100%" class="small-img">
					</div>
					<div class="small-img-col">
						<img src="images/brownie4.jpg" width="100%" class="small-img">
					</div>
				</div>
			...
			<div class="col-2">
				...
				<input type="hidden" name="Item_Name" value="TFN BROWNIE">
