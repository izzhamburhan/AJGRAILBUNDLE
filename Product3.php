...
<!--------single products details------->
	...
	<div class="small-container single-product">
		<div class="row">
			<div class="col-2">
				<img src="images/cheese.jpg" width="100%" id="ProductImg">
				
				<div class="small-img-row">
					<div class="small-img-col">
						<img src="images/cheese.jpg" width="100%" class="small-img">
					</div>
					<div class="small-img-col">
						<img src="images/cheese2.jpg" width="100%" class="small-img">
					</div>
					<div class="small-img-col">
						<img src="images/cheese3.jpg" width="100%" class="small-img">
					</div>
					<div class="small-img-col">
						<img src="images/cheese4.jpg" width="100%" class="small-img">
					</div>
				</div>
			...
			<div class="col-2">
				...
				<input type="hidden" name="Item_Name" value="WONDER CHEESE">
				<input type="hidden" name="Price" value="25">
				
				<h3>Product Details</h3>
				<p>
				Wonder Cheese
				<br>Snek Berperisa Keju
				<br>
				<br>Ingredient: Wheat flour, Cheese, Chili, Sugar & Salt
				<br>Weight : 500gm
				</p>
			</div>
			</form>
