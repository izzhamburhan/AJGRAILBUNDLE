...
<!-----------featured products---------->
	<div class="small-container">
		...
		<div class="row">
			...
			<div class="col-4">		
				<a href="Product1.php" >
					<img src = "photo/<?php echo $photo[0]?>"height = "200" width = "350"> 
				</a>
			...
			<div class="col-4">		
				<a href="Product1.php" >
					<img src = "photo/<?php echo $photo[1]?>"height = "200" width = "350"> 
				</a>
			...
			<div class="col-4">		
				<a href="Product1.php" >
					<img src = "photo/<?php echo $photo[2]?>"height = "200" width = "350"> 
				</a>
				<h4><?php echo $type[2]?></h4>								
				<div class="rating">
			...
			<div class="col-4">		
				<a href="Product1.php" >
					<img src = "photo/<?php echo $photo[3]?>"height = "200" width = "350"> 
				</a>
				<h4><?php echo $type[3]?></h4>								
				<div class="rating">
